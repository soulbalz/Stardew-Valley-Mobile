...
public class VillagerDetailGiftBadRecyclerAdapter extends RecyclerView.Adapter<VillagerDetailGiftBadRecyclerAdapter.ViewHolder> {
    ...
    public VillagerDetailGiftBadRecyclerAdapter(JSONArray dataSet) {
        mDataSet = dataSet;
