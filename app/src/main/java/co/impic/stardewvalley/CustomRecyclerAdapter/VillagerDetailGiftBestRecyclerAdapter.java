 ...
 */
public class VillagerDetailGiftBestRecyclerAdapter extends RecyclerView.Adapter<VillagerDetailGiftBestRecyclerAdapter.ViewHolder> {
    ...
    public VillagerDetailGiftBestRecyclerAdapter(JSONArray dataSet) {
        mDataSet = dataSet;
