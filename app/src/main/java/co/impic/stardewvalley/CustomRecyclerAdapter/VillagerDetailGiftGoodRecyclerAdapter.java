 ...
 */
public class VillagerDetailGiftGoodRecyclerAdapter extends RecyclerView.Adapter<VillagerDetailGiftGoodRecyclerAdapter.ViewHolder> {
    ...
    public VillagerDetailGiftGoodRecyclerAdapter(JSONArray dataSet) {
        mDataSet = dataSet;
