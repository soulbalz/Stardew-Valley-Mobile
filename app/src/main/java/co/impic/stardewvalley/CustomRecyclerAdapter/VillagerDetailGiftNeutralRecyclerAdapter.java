 ...
 */
public class VillagerDetailGiftNeutralRecyclerAdapter extends RecyclerView.Adapter<VillagerDetailGiftNeutralRecyclerAdapter.ViewHolder> {
    ...
    public VillagerDetailGiftNeutralRecyclerAdapter(JSONArray dataSet) {
        mDataSet = dataSet;
